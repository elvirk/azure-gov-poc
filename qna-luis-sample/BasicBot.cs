...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class BasicBot : IBot
    {
        ...
        public BasicBot(BotServices services, UserState userState, ConversationState conversationState, ILoggerFactory loggerFactory,  IConfiguration config)
        {
                ...
                if (!dc.Context.Responded)
                {
                    ...
                    switch (dialogResult.Status)
                    {
                        case DialogTurnStatus.Empty:
                            if (string.IsNullOrEmpty(topIntent) || topIntent == NoneIntent)
                            {
                                await dc.Context.SendActivityAsync("I didn't understand what you just said to me.");
                            }
                            else
                            {
                                var text = _config[topIntent];
            ...
            else if (activity.Type == ActivityTypes.ConversationUpdate)
            {
                if (activity.MembersAdded != null)
                {
                    ...
                    foreach (var member in activity.MembersAdded)
                    {
                        ...
                        {
                            await dc.Context.SendActivityAsync("What would you like to know about the [organization name]?");
                        }
                    }
                }
            }
